 ...
 */
(function () {
    var BSTable = function (bstableId, url, columns,height,DbClickRow,PageSize) {
        ...
        if(height){
            this.height = height;						//默认表格高度665
        }else{
            this.height=665
        }
        this.data = {};
        this.queryParams = {}; // 向后台传递的自定义参数
        this.DbClickRow=DbClickRow;
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    pageList: [20, 50, 1000,10000],  	//可供选择的每页的行数（*）
                    ...
                    height: this.height,
                    singleSelect: this.singleSelect,//设置是否单选
                    maintainSelected: this.maintainSelected,//设置是否多选
                    icons: {
        ...
        /**
         * 设置单选或者多选,单选为false，多选为true
         * @param param
         */
        setMainTainSelected: function (select) {
            if(select){
    ...
    var selectBSTable = function (bstableId, url, columns,queryData,height,DbClickRow) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        this.method = "post";
        ...
        this.data = {};
        this.queryParams = queryData; // 向后台传递的自定义参数
        this.DbClickRow=DbClickRow;
        // this.rowStyle=rowStyle;
    };

    selectBSTable.prototype = {
        /**
         * 初始化bootstrap table
         */
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    pageNumber: 1,      			//初始化加载第一页，默认第一页
                    pageSize: 20,      			//每页的记录行数（*）
                    pageList: [20, 50, 1000],  	//可供选择的每页的行数（*）
                    queryParamsType: 'limit', 	//默认值为 'limit' ,在默认情况下 传给服务端的参数为：offset,limit,sort
                    queryParams: function (param) {
                        return $.extend(me.queryParams, param);
                    }, // 向后台传递的自定义参数
    ...
    window.selectBSTable = selectBSTable;
