...
public class GunsUserFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if(httpServletRequest.getRequestURL().toString().contains("/mgr/user_add") || httpServletRequest.getRequestURL().toString().contains("/partyDept/tree") || httpServletRequest.getRequestURL().toString().contains("/mgr/add")
                || httpServletRequest.getRequestURL().toString().contains("/mgr/user_forget") || httpServletRequest.getRequestURL().toString().contains("/base/send_email") ){
            return true;
        }
        /**
         * 如果是ajax请求则不进行跳转
