...
//            System.out.println("值:"+o);
        if(o!=null){//只要有1个属性不为空,那么就不是所有的属性值都为空
        flag = false;
        break;
        }
        }
...
//                    }
    ...
    public static <T> T convertMapToBeanNew(Class<T> clazz, Map<String,Object> map) throws InvocationTargetException, IllegalAccessException, IntrospectionException, InstantiationException {
        T obj = null;
        ...
        for (Field f : clazz.getDeclaredFields()) {
            ...
            if (map.containsKey(propertyName)) {
                ...
                Method writeMethod = pd.getWriteMethod();//获得读方法
                writeMethod.invoke(obj, map.get(propertyName));
            }
        }
        return (T) obj;
